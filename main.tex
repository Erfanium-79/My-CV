...
% \section{Test Scores snd Language Skills}
% \begin{cvcolumns}
%     \cvcolumn[0.5]{IELTS Score}{
%     \begin{itemize}
%         \item Overal Score: 7.5
%             \begin{itemize}
%             \vspace{0.3em}
%                 \begin{multicols}{2}
%                     \item {Listening:8} 
...
%     \end{itemize}
%     }
%     \cvcolumn[0.5]{GRE Score}{
%     \begin{itemize}
%         \item Quantitative Reasoning: 160
%         \item VerbalReasoning: 160
%         \item Analatical Writing: 4.5
%     \end{itemize}
%     }
% \end{cvcolumns}
% \vspace{-2.5em}
...
\section{Certificates}
    \begin{multicols}{2}
        \begin{itemize}
            ...
            % \href{https://www.coursera.org/learn/advanced-computer-vision-with-tensorflow/}{Advanced Computer Vision with TensorFlow}
        
            % \item \authorimg{Images/docker.png}
            % \href{https://www.coursera.org/specializations/deep-learning}{Deep Learning Specialization}
        
            % \item \authorimg{Images/docker.png}
            % \href{https://www.coursera.org/learn/python-mlops-duke}{Python Essentials for MLOps}
        
            % \item \authorimg{Images/python.png} \href{https://www.coursera.org/professional-certificates/aws-cloud-solutions-architect}{Deploying Machine Learning Models in Production} 
            
            % \item \authorimg{Images/python.png} \href{https://www.coursera.org/professional-certificates/aws-cloud-solutions-architect}{AWS Cloud Solutions Architect Professional Certificate}
